...
@Component({
  selector: 'np-ui-dropdown',
  templateUrl: './np-ui-dropdown.component.html',
  styleUrls: ['./np-ui-dropdown.component.css'],
  encapsulation: ViewEncapsulation.None,
  changeDetection: ChangeDetectionStrategy.Default,
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => NpUiDropdownComponent),
      multi: true
    }
  ]
})
export class NpUiDropdownComponent implements ControlValueAccessor, AfterViewInit, AfterContentInit {
