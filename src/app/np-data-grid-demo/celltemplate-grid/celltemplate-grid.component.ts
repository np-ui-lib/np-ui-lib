...
export class CelltemplateGridComponent implements OnInit {
  ...
  @ViewChild("activeColumnTemplate", { static: true })
  activeColumnTemplate: TemplateRef<any>;
  @ViewChild("avatarColumnTemplate", { static: true })
  avatarColumnTemplate: TemplateRef<any>;
  ...
  ngOnInit() {
    this.gridColumns = [
      ...
      new Column({
        ...
        sortEnable: true,
        filterEnable: true,
        cellTemplate: this.activeColumnTemplate,
        width: 100,
        trueFilterText: "Yes",
        falseFilterText: "No",
      }),
