...
export class NpMenubarDemoComponent implements OnInit {
  ...
  items: NpMenuItem[] = [
    ...
    new NpMenuItem({ label: "Menu 3 click", onClick: this.onClickMenu3 }),
    new NpMenuItem({
      label: "Menu 4",
      items: [
        new NpMenuItem({
          label: "Menu 4.1",
          items: [
            new NpMenuItem({ label: "Menu 4.1.1", url: "/menu4.1.1" }),
            new NpMenuItem({ label: "Menu 4.1.2", url: "/menu4.1.2" }),
  ...
  itemsHorizontal: NpMenuItem[] = [
    ...
    new NpMenuItem({ label: "Menubar router link", routerLink: "/np-menubar-demo", activeClass: "active-menu" }),
    new NpMenuItem({ label: "Menu 3 click", onClick: this.onClickMenu3 }),
    new NpMenuItem({
      label: "Menu 4",
      items: [
