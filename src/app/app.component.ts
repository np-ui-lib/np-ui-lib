...
export class AppComponent implements OnInit {
  ...
  menuItems = [
    ...
    new NpMenuItem({ isHeader: true, label: 'Input', iconCss: 'fab fa-wpforms' }),
    ...
    new NpMenuItem({ isHeader: true, label: 'Panel', iconCss: 'fa fa-columns' }),
    ...
    new NpMenuItem({ isHeader: true, label: 'Message', iconCss: 'fas fa-comment-alt' }),
    new NpMenuItem({ routerLink: '/np-alert-demo', label: 'Alert' }),
    new NpMenuItem({ routerLink: '/np-notifications-demo', label: 'Notifications' }),
    new NpMenuItem({ isHeader: true, label: 'Overlay', iconCss: 'fa fa-layer-group' }),
