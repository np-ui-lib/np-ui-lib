...
const routes: Routes = [
  {
    ...
    path: 'np-button-demo',
    loadChildren: () => import('./np-button-demo/np-button-demo.module').then(m => m.NpButtonDemoModule)
  }, {
    path: 'np-badge-demo',
    loadChildren: () => import('./np-badge-demo/np-badge-demo.module').then(m => m.NpBadgeDemoModule)
  }, {
    path: 'np-form-demo',
